...
> Lab environment setup: The executable for this lab can be downloaded from the following link [dyn4m1c_cr4ckm3](https://github.com/outofsrvc/entry-p01nt/blob/main/assets/binaries/dyn4m1c_cr4ckm3.7z) in the course repository. Archive password: **p01nt**
...
![Program running](/assets/img/posts/dynamic/dynamic-run.png)
_Figure (1)_
...
![PE-Bear1](/assets/img/posts/dynamic/PE-bear1.png)
_Figure (2)_
...
![PE-Bear2](/assets/img/posts/dynamic/PE-bear2.png)
_Figure (3)_
...
![x64dbg1](/assets/img/posts/dynamic/x1.png)
_Figure (4)_
...
![x64dbg2](/assets/img/posts/dynamic/x2.png)
_Figure (5)_
...
![x64dbg3](/assets/img/posts/dynamic/x3.png)
_Figure (6)_
...
![x64dbg4](/assets/img/posts/dynamic/x4.png)
_Figure (7)_
...
![x64dbg5](/assets/img/posts/dynamic/x5.png)
_Figure (8)_

* Change the instruction from `je` (jump if equal) to `jne` (jump if not equal).

![x64dbg6](/assets/img/posts/dynamic/x6.png)
_Figure (9)_
...
![x64dbg7](/assets/img/posts/dynamic/x7.png)
_Figure (10)_
...
![x64dbg8](/assets/img/posts/dynamic/x8.png)
_Figure (11)_
...
![x64dbg9](/assets/img/posts/dynamic/x9.png)
_Figure (12)_
...
![x64dbg10](/assets/img/posts/dynamic/x10.png)
_Figure (13)_
...
![x64dbg11](/assets/img/posts/dynamic/x11.png)
_Figure (14)_

We perform another patch here: click on `jne` and press `Space`, then change it to `je`. We press `F8` to continue. We observe that the Zero Flag (`ZF`) equals zero, and because we changed the instruction to `je`, the program will treat the comparison as successful and jump toward the success message.

![x64dbg12](/assets/img/posts/dynamic/x12.png)
_Figure (15)_

We continue pressing `F8` until we reach the `memset` call or the end of the procedure.

![x64dbg13](/assets/img/posts/dynamic/x13.png)
_Figure (16)_

If we take a look at the CMD window now:

![x64dbg14](/assets/img/posts/dynamic/x14.png)
_Figure (17)_
...
![x64dbg15](/assets/img/posts/dynamic/x15.png)
_Figure (18)_
